...
- (void)createScrollView
{
    ...
    [CommonUtil addValue:[NSString stringWithFormat:@"%d",_photos.count] andKey:@"MJ_photos.count"];
    [CommonUtil addValue:@"" andKey:@"MJ_hide_photos.count"];
...
- (void)loadImageNearIndex:(int)index
{
    if (index > 0) {
        ...
        [HHImageManager downloadWithURL:photo.url];
    }
