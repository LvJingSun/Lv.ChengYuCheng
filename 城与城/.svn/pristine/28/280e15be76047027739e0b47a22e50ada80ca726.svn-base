...
//{
//	return [[self class] generateUUIDa];
//}
//
//
//
////原方法用下面方法替代
//
//- (void)configureRoomUsingOptions:(NSXMLElement *)roomConfigForm jid:(NSString *)jid
//{
//    
//    
//    dispatch_block_t block = ^{ @autoreleasepool { XMPPLogTrace();
//        if (roomConfigForm) {
//    // Explicit configuration using given form. // // <iq type='set' // id='create2' // to='coven@chat.shakespeare.lit'> // <query xmlns='http://jabber.org/protocol/muc#owner'> // <x xmlns='jabber:x:data' type='submit'> // <field var='FORM_TYPE'> // <value>http://jabber.org/protocol/muc#roomconfig</value> // </field> // <field var='muc#roomconfig_roomname'> // <value>A Dark Cave</value> // </field> // <field var='muc#roomconfig_enablelogging'> // <value>0</value> // </field> // ... // </x> // </query> // </iq>
//    
//    NSXMLElement *x = roomConfigForm; [x addAttributeWithName:@"type" stringValue:@"submit"]; NSXMLElement *query = [NSXMLElement elementWithName:@"query" xmlns:XMPPMUCOwnerNamespace];
//    NSXMLElement *field = [NSXMLElement elementWithName:@"field"]; // 固定房间属性
//    NSXMLElement *value = [NSXMLElement elementWithName:@"value"]; // 固定房间value
//    NSXMLElement *fieldowners = [NSXMLElement elementWithName:@"field"]; // 房间属于谁
//    NSXMLElement *valueowners = [NSXMLElement elementWithName:@"value"]; // 创建者的jid
...
//    [field addAttributeWithName:@"type" stringValue:@"jid-multi"];
//    [value setStringValue:@"1"]; [valueowners setStringValue:jid];
//    [x addChild:field];
//    [x addChild:fieldowners];
//    [field addChild:value];
//    [fieldowners addChild:valueowners];
//    [query addChild:x]; NSString *iqID = [xmppStream generateUUID];
//    XMPPIQ *iq = [XMPPIQ iqWithType:@"set" to:roomJID elementID:iqID child:query]; [xmppStream sendElement:iq];
//    [responseTracker addID:iqID target:self selector:@selector(handleConfigureRoomResponse:withInfo:) timeout:60.0];
//}
//else
//{
//    // Default room configuration (as per server settings). // // <iq type='set' // from='crone1@shakespeare.lit/desktop' // id='create1' // to='darkcave@chat.shakespeare.lit'> // <query xmlns='http://jabber.org/protocol/muc#owner'> // <x xmlns='jabber:x:data' type='submit'/> // </query> // </iq>
//    
//    NSXMLElement *x = [NSXMLElement elementWithName:@"x" xmlns:@"jabber:x:data"];
//    [x addAttributeWithName:@"type" stringValue:@"submit"];
//    NSXMLElement *query = [NSXMLElement elementWithName:@"query" xmlns:XMPPMUCOwnerNamespace];
...
//    NSString *iqID = [xmppStream generateUUID];
//    XMPPIQ *iq = [XMPPIQ iqWithType:@"set" to:roomJID elementID:iqID child:query];
//    [xmppStream sendElement:iq]; [responseTracker addID:iqID target:self selector:@selector(handleConfigureRoomResponse:withInfo:) timeout:60.0]; } }};
//    if (dispatch_get_specific(moduleQueueTag)) block();
//    else dispatch_async(moduleQueue, block);
//}
