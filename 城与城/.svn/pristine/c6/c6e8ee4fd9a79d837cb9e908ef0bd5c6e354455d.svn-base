...
-(void)setFrameWith:(BOOL)isHaveNavControler{
    ...
    self.frame = CGRectMake(toolViewX, WindowSize.size.height, toolViewW, toolViewH);
...
-(void)remove{
    ...
    if ([self.delegate respondsToSelector:@selector(HidetoobarDonBtnHaveClick:)]) {
        [self.delegate HidetoobarDonBtnHaveClick:nil];
    }
}
//-(void)show{
//    
