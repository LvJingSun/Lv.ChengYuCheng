...
- (id) initWithFrame:(CGRect)theFrame cancelEnabled:(BOOL)isCancelEnabled oneDMode:(BOOL)isOneDModeEnabled showLicense:(BOOL)showLicenseButton {
    ...
    if( self ) {
        ...
        //      readline =[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"line_scan_red_02.png"]];
        //      readline.contentMode = UIViewContentModeScaleAspectFit;
        //      readline.frame=CGRectMake(0, 0, 320, 9);
        //      [self addSubview:readline];
        //      [self addAnimations];
...
//	translation.fromValue = [NSValue valueWithCGPoint:CGPointMake(160, 130)];
//	translation.toValue = [NSValue valueWithCGPoint:CGPointMake(160, 384)];
//	translation.duration = 2;
//	translation.repeatCount = 9.0;
