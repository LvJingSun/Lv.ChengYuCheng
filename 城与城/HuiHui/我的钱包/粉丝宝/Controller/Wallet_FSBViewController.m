...
@interface Wallet_FSBViewController ()<UITableViewDelegate,UITableViewDataSource,GameBtnCellDelegate> {
...
@implementation Wallet_FSBViewController

-(NSArray *)Menus {

    if (_Menus == nil) {
        
        NSString *path = [[NSBundle mainBundle] pathForResource:@"Wallet_FSB_Menu.plist" ofType:nil];
...
-(void)viewWillAppear:(BOOL)animated {
    ...
    [self requestForFSBbalance];
    
    [self requestForFSBgetout];
...
- (void)MingXiClicked {
    ...
    Wallet_FSB_RecordViewController *vc = [[Wallet_FSB_RecordViewController alloc] init];
