...
@implementation FSB_TranCell

+ (instancetype)FSB_TranCellWithTableview:(UITableView *)tableview {

    static NSString *cellID = @"FSB_TranCell";
    
    FSB_TranCell *cell = [tableview dequeueReusableCellWithIdentifier:cellID];
    
    if (cell == nil) {
        
        cell = [[FSB_TranCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
...
-(void)setFrameModel:(FSB_TranFrame *)frameModel {
