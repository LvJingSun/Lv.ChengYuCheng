...
@implementation GoldTranHeadView
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        UISegmentedControl *segm = [[UISegmentedControl alloc] initWithItems:@[@"全部",@"获取",@"卖出"]];
...
//    if ([self.delegate respondsToSelector:@selector(TranTypeChange:)]) {
//        
//        [self.delegate TranTypeChange:segm];
//        
//    }
