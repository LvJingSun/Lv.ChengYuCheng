...
@implementation YCB_TranDetailCell

+ (instancetype)YCB_TranDetailCellWithTableview:(UITableView *)tableview {

    static NSString *cellID = @"YCB_TranDetailCell";
    
    YCB_TranDetailCell *cell = [tableview dequeueReusableCellWithIdentifier:cellID];
    
    if (cell == nil) {
        
        cell = [[YCB_TranDetailCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
...
-(void)setFrameModel:(YCB_TranDetailFrame *)frameModel {
