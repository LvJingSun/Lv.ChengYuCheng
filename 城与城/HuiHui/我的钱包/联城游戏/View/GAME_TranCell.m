...
@implementation GAME_TranCell

+ (instancetype)GAME_TranCellWithTableview:(UITableView *)tableview {

    static NSString *cellID = @"GAME_TranCell";
    
    GAME_TranCell *cell = [tableview dequeueReusableCellWithIdentifier:cellID];
    
    if (cell == nil) {
        
        cell = [[GAME_TranCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
...
-(void)setFrameModel:(GAME_TranFrame *)frameModel {
