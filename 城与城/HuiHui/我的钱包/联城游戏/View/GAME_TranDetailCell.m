...
@implementation GAME_TranDetailCell

+ (instancetype)GAME_TranDetailCellWithTableview:(UITableView *)tableview {

    static NSString *cellID = @"GAME_TranDetailCell";
    
    GAME_TranDetailCell *cell = [tableview dequeueReusableCellWithIdentifier:cellID];
    
    if (cell == nil) {
        
        cell = [[GAME_TranDetailCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
...
-(void)setFrameModel:(GAME_TranDetailFrame *)frameModel {
...
- (void)setContent {
    ...
    GAME_TranModel *model = self.frameModel.tranmodel;
