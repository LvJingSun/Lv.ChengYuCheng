...
//    
////    sourceArr = imageArray;
////    
////    NSLog(@"3333%@",imageArray);
////    
////    selectionType = FFScrollViewSelecttionTypeTap;
////    
////    self.userInteractionEnabled = YES;
////    
////    [self iniSubviewsWithFrame:basicFrame];
//    
//    [self drawWithFrame:basicFrame array:imageArray];
//    
//}
//
//- (void)drawWithFrame:(CGRect)frame array:(NSArray *)array {
//
//    selectionType = FFScrollViewSelecttionTypeTap;
//    sourceArr = array;
//    self.userInteractionEnabled = YES;
...
{
    NSLog(@"%f  %@",frame.size.width,sourceArr);
...
//    if ([objName isEqualToString:@"GameImageModel"]) {
//        
//        GameImageModel *model = [sourceArr lastObject];
//        
//        [firstImageView setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",model.GameLinkPhtoto]] placeholderImage:[UIImage imageNamed:@""]];
//        
...
//    }else {
    ...
    [firstImageView setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",[sourceArr lastObject]]] placeholderImage:[UIImage imageNamed:@""]];
...
//        if ([objName isEqualToString:@"GameImageModel"]) {
//            
//            GameImageModel *model = [sourceArr objectAtIndex:i];
//            
//            [firstImageView setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",model.GameLinkPhtoto]] placeholderImage:[UIImage imageNamed:@""]];
//            
...
//        }else {
        ...
        [imageview setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",[sourceArr objectAtIndex:i]]] placeholderImage:[UIImage imageNamed:@""]];
...
//    if ([objName isEqualToString:@"GameImageModel"]) {
//        
//        GameImageModel *model = [sourceArr objectAtIndex:0];
//        
//        [firstImageView setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",model.GameLinkPhtoto]] placeholderImage:[UIImage imageNamed:@""]];
//        
...
//    }else {
    ...
    [lastImageView setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",[sourceArr objectAtIndex:0]]] placeholderImage:[UIImage imageNamed:@""]];
