...
+ (instancetype)LJSettingCellWithTableview:(UITableView *)tableview {
    ...
    static NSString *cellID = @"LJSettingCell";
    
    LJSettingCell *cell = [tableview dequeueReusableCellWithIdentifier:cellID];
    
    if (cell == nil) {
        
        cell = [[LJSettingCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
