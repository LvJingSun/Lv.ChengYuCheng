...
- (void)setupSubviewsForType:(ChatMoreType)type
{
    ...
    CGRect rec1 = CGRectMake(insets, 60, CHAT_BUTTON_SIZE, 20);
    [self addlabel:rec1 Name:@"照片"];
    ...
    CGRect rec2 = CGRectMake(insets * 2 +CHAT_BUTTON_SIZE, 60, CHAT_BUTTON_SIZE, 20);
    [self addlabel:rec2 Name:@"位置"];
    ...
    CGRect rec3 = CGRectMake(insets * 3 +CHAT_BUTTON_SIZE *2, 60, CHAT_BUTTON_SIZE, 20);
    [self addlabel:rec3 Name:@"拍照"];
    ...
    CGRect rec4 = CGRectMake(insets * 4 +CHAT_BUTTON_SIZE * 3, 60, CHAT_BUTTON_SIZE, 20);
    [self addlabel:rec4 Name:@"视频"];
...
-(void)addlabel:(CGRect)cgrect Name:(NSString *)name
{
