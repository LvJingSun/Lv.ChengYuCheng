...
- (EMChatBaseBubbleView *)bubbleViewForMessageModel:(MessageModel *)messageModel
{
    ...
    if (messageModel.m_type) {
        
        if ([[NSString stringWithFormat:@"%@",messageModel.m_type] isEqualToString:@"PRO"]||[[NSString stringWithFormat:@"%@",messageModel.m_type] isEqualToString:@"WEB"]) {
        
            return [[EMChatcustomBubbleView alloc] init];
       
        }else if ([[NSString stringWithFormat:@"%@",messageModel.m_type] isEqualToString:@"DALI"])
        {
            
            return [[EMChatDaliBubbleView alloc] init];
        
        }else if ([[NSString stringWithFormat:@"%@",messageModel.m_type] isEqualToString:@"MENU"])
        {
            
            return [[EMChatToHomeView alloc] init];
            
            
        }else if ([[NSString stringWithFormat:@"%@",messageModel.m_type] isEqualToString:@"game"])
        {
            
            return [[EMChatGameBubbleView alloc] init];
...
+ (CGFloat)bubbleViewHeightForMessageModel:(MessageModel *)messageModel
{
    ...
    if (messageModel.m_type) {
        ...
        {
            return [EMChatDaliBubbleView heightForBubbleWithObject:messageModel];
        }else if ([[NSString stringWithFormat:@"%@",messageModel.m_type] isEqualToString:@"MENU"])
        {
            return [EMChatToHomeView heightForBubbleWithObject:messageModel];
        }else if ([[NSString stringWithFormat:@"%@",messageModel.m_type] isEqualToString:@"game"])
        {
            return [EMChatGameBubbleView heightForBubbleWithObject:messageModel];
        }
    }else
    {
    switch (messageModel.type) {
