...
//	id<YKAddShopCartAnimationDelegate> delegate;
...
@property(nonatomic,retain) UIImageView *iv_goods;
@property(nonatomic,assign) id<YKAddShopCartAnimationDelegate> delegate;
-(void)showAnimation;
