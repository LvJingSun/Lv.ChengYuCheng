...
@interface Fl_webViewController ()

@property (weak, nonatomic) IBOutlet UIWebView *m_webView;

@end

@implementation Fl_webViewController
...
//    [[UIApplication sharedApplication] setStatusBarStyle:UIStatusBarStyleDefault];
    ...
    self.m_flightString = @"http://m.ly.com/flightnew/?refid=40019126";
    
    [self loadWebPageWithString:[NSString stringWithFormat:@"%@",self.m_flightString]];
...
- (void)leftClicked{
    ...
    UIActionSheet *sheet  = [[UIActionSheet alloc] initWithTitle:@"您正在查看机票信息"
                                                        delegate:self
...
//                    if ( label.tag == 10392 ) {
//                        
//                        label.backgroundColor = RGBACKTAB;
//                        
//                    }
//                }
//                
...
//    NSLog(@"navigationType = %li",navigationType);
    ...
    // 判断以这开头的字符的网址不进行跳转
//    if ( [string hasPrefix:@"http://m.17u.cn/"] ) {
//        
//        return NO;
//        
//    }
...
//    NSLog(@"ljs = %@,ljs2 = %@，ljs3 = %@",ljs,lJs2,ljs3);
