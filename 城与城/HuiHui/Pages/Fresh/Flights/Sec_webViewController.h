...
@interface Sec_webViewController : BaseViewController<UIWebViewDelegate,UIActionSheetDelegate,CommonShareDelegate>


@property (strong, nonatomic) NSString *m_seceryString;
