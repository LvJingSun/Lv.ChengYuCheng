...
@protocol DX_MerMessageToolBarDelegate;
@interface DX_MerMessageToolBar : UIView

@property (nonatomic, weak) id <DX_MerMessageToolBarDelegate> delegate;
...
@protocol DX_MerMessageToolBarDelegate <NSObject>
