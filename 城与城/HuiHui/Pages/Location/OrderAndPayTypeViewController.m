...
- (void)viewDidLoad
{
    ...
    [self.m_typeDic setValue:@"0" forKey:@"6"];
    ...
    if ( indexPath.row == 0 ) {
        ...
        if ( indexPath.row == 2 ) {
            ...
            if ([self.ruKou isEqualToString:@"normal"]) {
                ...
                cell.m_titleLabel.text = @"花花支付";
                
                cell.m_imageView.image = [UIImage imageNamed:@"icon-huahua.png"];
        ...
        if ( indexPath.row == 3 ) {
            ...
            cell.m_imageView.image = [UIImage imageNamed:@"alipay"];
...
//            cell.m_titleLabel.text = @"支付宝支付";
//            
//            cell.m_imageView.image = [UIImage imageNamed:@"alipay.png"];
//            
//            cell.m_imageView.frame = CGRectMake(cell.m_imageView.frame.origin.x, 7, cell.m_imageView.frame.size.width, 30);
//            
//            cell.m_banlanceLabel.hidden = YES;
...
- (void)choosePayTypeClicked:(id)sender{
    ...
    if ( btn.tag == 3 ) {
        ...
        [self.m_typeDic setValue:@"1" forKey:@"6"];
...
- (IBAction)sureSubmitOrder:(id)sender {
    ...
    if ( [self.m_typeString isEqualToString:@"3"] ) {
        ...
        if ([self.m_zhifubao isEqualToString:@"1"]) {
            ...
            //表示平台支付宝支付
        {
            [SVProgressHUD showErrorWithStatus:@"暂不支持支付宝支付"];
        }
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex{
    ...
    }else if (alertView.tag == 123454321) {
