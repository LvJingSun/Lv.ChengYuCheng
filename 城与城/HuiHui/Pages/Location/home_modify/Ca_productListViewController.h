...
@interface Ca_productListViewController : BaseViewController<UITableViewDataSource,UITableViewDelegate,UIScrollViewDelegate,UISearchBarDelegate,PullTableViewDelegate,DPRequestDelegate>{
...
// 判断筛选的条件是否是离我最近，如果是离我最近的，则显示分区的形式，如果不是则显示列表的形式
