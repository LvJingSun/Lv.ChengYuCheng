...
@interface DScale_productListViewController : BaseViewController<UITableViewDataSource,UITableViewDelegate,UIScrollViewDelegate,UISearchBarDelegate,PullTableViewDelegate,DPRequestDelegate>{
