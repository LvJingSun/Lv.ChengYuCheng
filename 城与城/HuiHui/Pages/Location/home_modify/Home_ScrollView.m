...
@implementation Home_ScrollView
...
//        if ([objName isEqualToString:@"Home_ScrollModel"]) {
    
            Home_ScrollModel *modelLast = [sourceArr lastObject];
            
            [firstImageView setImageWithURL:[NSURL URLWithString:modelLast.AdImg] placeholderImage:[UIImage imageNamed:@"invite_reg_no_photo.png"]];
...
//        if ([objName isEqualToString:@"Home_ScrollModel"]) {
            ...
            Home_ScrollModel *modeli = [sourceArr objectAtIndex:i];
        
            [imageview setImageWithURL:[NSURL URLWithString:modeli.AdImg] placeholderImage:[UIImage imageNamed:@"invite_reg_no_photo.png"]];
...
//    if ([objName isEqualToString:@"Home_ScrollModel"]) {
        ...
        Home_ScrollModel *model0 = [sourceArr objectAtIndex:0];
    
        [lastImageView setImageWithURL:[NSURL URLWithString:model0.AdImg] placeholderImage:[UIImage imageNamed:@"invite_reg_no_photo.png"]];
