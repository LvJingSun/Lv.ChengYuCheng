...
@interface all_merchantViewController ()
...
@implementation all_merchantViewController
...
- (void)loadData {
    ...
    [httpClient request:@"MerchantListTop_1_0.ashx" parameters:param success:^(NSJSONSerialization* json) {
        ...
        if (success) {
            ...
            if (pageIndex == 1) {
                if (metchantShop == nil || metchantShop.count == 0) {
                    ...
                    self.m_emptyLabel.text = @"该地区暂无商户信息！";
