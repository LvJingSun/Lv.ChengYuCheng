...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSMutableDictionary *dic = [self.m_productArray objectAtIndex:indexPath.row];
    NSArray *MctList = [dic objectForKey:@"MctList"];
    if (MctList.count && [self.m_merchantShopId isEqualToString:@""]) {
        self.m_merchantShopId = [[MctList objectAtIndex:0] objectForKey:@"MerchantShopID"];
    }
