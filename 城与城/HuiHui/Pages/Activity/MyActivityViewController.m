...
- (void)viewDidLoad
{
    ...
    [self setRightButtonWithTitle:@"策划" action:@selector(rightClicked)];
...
- (void)rightClicked{
    ...
    // 发起活动
    LaunchActivityViewController *VC = [[LaunchActivityViewController alloc]initWithNibName:@"LaunchActivityViewController" bundle:nil];
    VC.m_StringType = @"1";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ( self.m_partyList.count != 0 ) {
        ...
        cell.m_orignPriceLabel.hidden = NO;
        
        cell.m_lineLabel.hidden = NO;
        
        cell.m_priceLabel.frame = CGRectMake(cell.m_priceLabel.frame.origin.x, cell.m_priceLabel.frame.origin.y, size.width + 5, 21);
        
        cell.m_orignPriceLabel.frame = CGRectMake(cell.m_priceLabel.frame.origin.x + size.width + 5, cell.m_orignPriceLabel.frame.origin.y, size1.width + 2, 21);
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex{
    ...
    if ( alertView.tag == 1101 ) {
        ...
        if ( buttonIndex == 1 ) {
            ...
            LaunchActivityViewController *VC = [[LaunchActivityViewController alloc]initWithNibName:@"LaunchActivityViewController" bundle:nil];
            VC.m_StringType = @"2";
            [VC.m_dic setObject:[dic objectForKey:@"ActivityID"] forKey:@"ActivityID"];
            [self.navigationController pushViewController:VC animated:YES];
