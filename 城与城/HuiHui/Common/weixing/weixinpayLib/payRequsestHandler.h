...
#define APP_ID          @"wx67aeb251adaae095"                 //APPID
#define APP_SECRET      @""                                   //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"1241760602"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"cityandcity20150518tinge633tony1"
//支付结果回调页面
//#define NOTIFY_URL      @"http://wxpay.weixin.qq.com/pub_v2/pay/notify.v2.php"

#define NOTIFY_URL      @"http://wx.cityandcity.com/wxpays/mobilenotifysvc_url.aspx"
