...
@interface MR_MerchantViewController () <UITableViewDelegate,UITableViewDataSource,FSB_AllWealthHeadViewDelegate>
...
@implementation MR_MerchantViewController
...
- (void)requestForData {
    ...
    [httpClient request:@"MctRPFansMemIndex.ashx" parameters:param success:^(NSJSONSerialization* json) {
