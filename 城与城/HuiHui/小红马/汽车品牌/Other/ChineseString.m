...
+(NSMutableArray*)LetterSortArray:(NSArray*)stringArr
{
    ...
    for (NSString* object in tempArray) {
        ...
        if(![tempString isEqualToString:pinyin])
        {
            ...
            for (RH_CarBrandFrame *frame in stringArr) {
                
                if ([frame.brandmodel.Name isEqualToString:string]) {
...
+(NSMutableArray*)ReturnSortChineseArrar:(NSArray*)stringArr
{
    ...
    for(int i=0;i<[stringArr count];i++)
    {
        ...
        RH_CarBrandFrame *framemodel = [stringArr objectAtIndex:i];
        
        RH_CarBrandModel *carmodel = framemodel.brandmodel;
        
        chineseString.string=[NSString stringWithString:carmodel.Name];
...
+(NSMutableArray*)SortArray:(NSArray*)stringArr
{
    ...
    for(int i=0;i<[stringArr count];i++){
        ...
        for (RH_CarBrandFrame *frame in stringArr) {
            ...
            if ([frame.brandmodel.Name isEqualToString:((ChineseString*)[tempArray objectAtIndex:i]).string]) {
