...
@interface GameGifAlertView() <CAAnimationDelegate> {
...
@implementation GameGifAlertView
...
-(void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    ...
    if ([self.delegate respondsToSelector:@selector(GifViewClick)]) {
        
        [self.delegate GifViewClick];
