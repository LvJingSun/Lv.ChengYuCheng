//
//  HL_DelegateOrderViewController.m
//  HuiHui
//
...
#import "HL_DelegateOrderFrame.h"
...
@implementation HL_DelegateOrderViewController
...
-(NSArray *)orderInfoArray {
    ...
    if (_orderInfoArray == nil) {
        ...
        HL_DelegateOrderFrame *frame = [[HL_DelegateOrderFrame alloc] init];
...
- (void)PayByZFB {
    ...
    [http HuLarequest:@"Agent/Pay_ALiPay.ashx" parameters:dic success:^(NSJSONSerialization *json) {
...
- (void)payByCYC {
    ...
    [http HuLarequest:@"Agent/Pay_CYC.ashx" parameters:dic success:^(NSJSONSerialization *json) {
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    HL_DelegateOrderCell *cell = [[HL_DelegateOrderCell alloc] init];
    
    HL_DelegateOrderFrame *frame = self.orderInfoArray[indexPath.row];
