...
@interface HL_DelegateOrderCell ()
...
@implementation HL_DelegateOrderCell

+ (instancetype)HL_DelegateOrderCellWithTableview:(UITableView *)tableview {
    
    static NSString *cellID = @"HL_DelegateOrderCell";
    
    HL_DelegateOrderCell *cell = [tableview dequeueReusableCellWithIdentifier:cellID];
    
    if (cell == nil) {
        
        cell = [[HL_DelegateOrderCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
...
-(void)setFrameModel:(HL_DelegateOrderFrame *)frameModel {
...
- (void)setContent {
    ...
    HL_DelegateOrderModel *model = self.frameModel.orderModel;
